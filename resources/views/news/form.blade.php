    ...
    <div class="row bg-title">
        ...
        <div class="col-lg-9 col-sm-8 col-md-8 col-xs-12">
            ...
            <ol class="breadcrumb">
                ...
                <li class="active">{{ empty($news->id) ? 'Thêm mới' : 'Sửa' }}</li>
            </ol>
        </div>
    </div>
          ...
          <div class="row">
            <div class="col-md-12">
              <div class="white-box">
                {!! Form::open(['url' => env('ADMIN_URL', '/').'newss/'.$news->_id, 'method' => empty($news->_id) ? 'POST' : 'PUT', 'role' => 'form', 'files' => 'true', 'class' => 'form-horizontal group-border-dashed', 'style' => 'border-radius: 0px;', 'id' => 'form_equipment',]) !!}
                  ...
                  <div class="header">
                    ...
                    @include('errors/error_validation', ['errors' => $errors])
                      <div class="form-group">
                        ...
                        <div class="col-sm-6">
                           {!! Form::text('title', $news->title, array('placeholder' => '', 'class' => 'form-control')) !!} 
                        </div>
                      </div>
                       <div class="form-group">
                        <label class="col-sm-3 control-label" >Nội dung ngắn</label>
                         <div class="col-sm-9">
                          <textarea name="short_content" id="short_content" class="form-control">{{ old('short_content') ? old('short_content') : $news->short_content }}</textarea>
                        </div>
                      </div>
                      <div class="form-group">
                        <label class="col-sm-3 control-label" >Nội dung</label>
                         <div class="col-sm-9">
                          <textarea name="content" id="content" class="rich_text">{{ old('content') ? old('content') : $news->content }}</textarea>
                        </div>
                      </div>
                      ...
                      <div class="form-group" id="form-role">
                        ...
                        <div class="col-sm-6">
                           <?php 
                                $data_languages = ['vi' => 'Tiếng Việt', 'en' => 'Tiếng Anh'];
                            ?>
                            
                            {!! Form::select('lang', $data_languages, $news->lang, array('id' => 'lang', 'class' => 'form-control')) !!}
                        </div>
                      </div>
                      ...
                      <div class="col-sm-6" >
                          @if (!empty($news->image))
                              <img src="{{ $news->urlPath('100x100') }}" id="image_temp" class="image-thumb-upload"/>
                          @else
